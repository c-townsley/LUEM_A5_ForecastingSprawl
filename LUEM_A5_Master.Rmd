...
```{r development predictions based on thresholds}
predsForMap <-         
  dat %>%
...
```{r development predictions based on confusion metrics}
...
highways_all <- st_read("C:/Users/Lindsey/Desktop/CPLN675_Land_Use_Modeling_Desktop/Final/LUEM_A5_Repo/Data/shapefile/AtlantaMetro_Major_Roads_ADDITION/Highways_addition_Merge.shp")
...
```{r mapping the new highway addition}
