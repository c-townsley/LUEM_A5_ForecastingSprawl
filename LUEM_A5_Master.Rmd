...
ggplot() +
  ...
  geom_raster(data=rast(development_change) %>% na.omit, 
    ...
    #                    labels = c("No Change, Undeveloped", "Developed since 2008", "No Change, Developed"),
                 #       name = "") +
  geom_sf(data=metro_counties,
          color = "black",
          fill = "transparent",
          linewidth = .5) +
  labs(title="Development Change 2008-2019", subtitle='Atlanta Metro Area; \n0 = No Change, Undeveloped, \n1 = Developed since 2008, \n2 = No Change, Developed')+
  mapTheme,
