...
```{r Plot land cover for 2008 and 2019, fig.height=13, fig.width=6}
grid.arrange(ncol = 1,
ggplot() +
...
Viewing land cover at the MSA level in 2008 and 2019 shows that change is happening at too small a scale to discern visually alone. Hence, the powers of R.
...
lc_2019r <- reclassify(lc_2019, reclassMatrix)
...
ggplot() +
  ...
  scale_fill_viridis(discrete=TRUE,
                     option="C",
                     name ="Land Cover\nChange") + 
  labs(title="Development Land Use Change") + #IS THIS ACTUALLY A MAP OF DEVELOPMENT LAND USE CHANGE?
  mapTheme
```
