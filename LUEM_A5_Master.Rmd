...
#writeRaster(new_highway_raster_distance, filename=file.path(rast_dir, "highways_dist.tif"), format="GTiff", overwrite=TRUE)
...
Fulton not suitable, clayton really not suitable, same with Dekalb.
