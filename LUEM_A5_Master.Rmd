...
```{r Import full original Land Cover data}
...
```{r downsample rasters and export, eval=FALSE}
#downsanoke the raster to make more manageable
...
lc_2019_crop <- raster::mask(x = lc_2019_crop, mask = metro_counties)
```
...
ggplot() +
  ...
  geom_sf(data=Atlanta_MSA, fill = "transparent", linewidth = .75) +
