...
The raster files are down sampled to make their size more manageable and then cropped to the MSA boundaries.
...
View landcover for 2008 and 2019 together.


```{r Plot land cover for 2008 and 2019, fig.height=10}
grid.arrange(ncol = 1,
ggplot() +
