...
testSetProbs %>%
  ...
  reactable()
    ...
    #kableExtra::kable() %>%
  #kableExtra::kable_styling(full_width = F) #not working for charlie
...
#which new highway do we use?
new_highway <- st_read("C:/Users/Lindsey/Desktop/CPLN675_Land_Use_Modeling_Desktop/Final/LUEM_A5_Repo/Data/shapefile/AtlantaMetro_Major_Roads_ADDITION/Highways_addition.shp")
...
#highways_all <- st_write(highways_addition,"C:/Users/Lindsey/Desktop/CPLN675_Land_Use_Modeling_Desktop/Final/LUEM_A5_Repo/Data/geojson/highways_all.geojson")

#is this supposed to be highways add?
...
Distribute projected population across the study area by weighting it according to a grid cell's 2019 population and then subtracting 2019 pop to get `pop_change`. Then, use Model XX to predict development for 2029 based on the projected population change and lag development features.
