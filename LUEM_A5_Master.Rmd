...
**Note:** we do not include forest in the "not suitable for development" category in these maps due to the large amount of tree cover in the Atlanta region's developed areas.
